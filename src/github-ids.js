...
export const VALID_GITHUB_IDS = [
  'ry',
  'himaashok0410-dotcom', 'devjain010', 'CalmOutlaws', 'Harshita-Shreevastav', 'Ashmitha-gif', 'vinay-d07', 'natalipawar', 'manaswi1710', 'decodechinnu18', 'nydhile77', 'shreyasmulekar', 'Kritika-Panwar-151', 'sakshisarraf31-gif', 'Ananya-Shetty-24', 'vismay-b-srinivas', 'achintyakumar237', 'abhishekv898', 'AnishVNairy', 'shivanvithajayam', 'NAYANA-N-13', 'brvinayak', 'bhaktichethan-bit', 'akshat-005', 'kusuma-r-dev', 'dmrudula-19', 'punithkumar-060308', 'vishruthab1306', 'SSThanishaShree', 'itz1cr', 'XCcutor', 'vaishnavi1u', 'AdiIrl18', 'adi-sach', 'dharyagoyal', 'anwesha01b', 'Rajen5145', 'AdithyaND12', 'smruthi006', 'Keerthana-M-06', 'archirkhatri', 'pushkar-code', 'sharathprime10-coder', 'Roshni13102007', 'LAKSHITA1206', 'Kakul29', 'NaisargPurohit', 'vedxnt-10', 'saicharanraju2005', 'dhruvaacharyacs24-repo', 'SaiChiranth-dev', 'anikanandish', 'achinthyam08', 'soha-k10', 'hrudaysai07', 'MishthyAgrawal', 'Harryhist', 'AdarshHegde001', 'HazalAliNachan', 'hema-ga', 'shashvath33-ux', 'Darshan-Biligiri', 'Dedeepya25', 'adarsh-mali', 'aishwaryagaler', 'swatinz-jpg',
  'bhanukiran29', 'Anadijain1234', 'keerthanat1310-tech', ' himesh007-git', 'sanchithakolur', 'NCS0307', 'scrU1k', 'sinchanabm-ux'
];
